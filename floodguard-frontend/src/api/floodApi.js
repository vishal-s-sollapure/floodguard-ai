...
export const nextSimulationStep = () => api.post('/api/simulation/next')
export const getSimulationStep = () => api.get('/api/simulation/current')
export const getSystemStatus = () => api.get('/api/health/system-status')
export const getRescueTeams = () => api.get('/api/dispatch/rescue-teams')
export const getDispatchRecommendations = () => api.get('/api/dispatch/recommendations')
export const assignRescueTeam = (data) => api.post('/api/dispatch/assign', data)
export const getResponseKPIs = () => api.get('/api/dispatch/kpi')
export const triggerOrchestration = (data) => api.post('/api/dispatch/orchestrate', data)
export const evaluateAnomalies = (data) => api.post('/api/dispatch/anomalies/evaluate', data)
